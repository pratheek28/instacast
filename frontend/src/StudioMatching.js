...
function StudioMatching() {
      ...
      { i < firstname.length ? (
        ...
        <div>
          ...
          <div style={{ marginTop: '24px' }}>
            ...
            {Array.isArray(actorgenres[i]) ? actorgenres[i].join(', ') : 'Nothing Left'}
            </p>
          </div>
          ...
          <div style={{ marginTop: '24px' }}>
            ...
            <p style={{ fontSize: '14px', color: '#333' }}>{actorlocation[i]}</p>
          </div>
        </div>
      </div>
  ...
  <div style={{ textAlign: 'center', marginTop: '100px' }}>
    <h1 style={{ fontSize: '28px', fontWeight: 'bold' }}>🎉 Matches Over!</h1>
    <p style={{ fontSize: '18px', color: '#555' }}>You’ve reviewed all potential matches.</p>
  </div>
)}
